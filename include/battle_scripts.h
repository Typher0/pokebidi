...
extern const u8 BattleScript_VampirismActivates[];
extern const u8 BattleScript_SlanderActivates[];
...
extern const u8 BattleScript_PassiveStatusClearCuresStatus[];
