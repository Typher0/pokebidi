...
#define P_FAMILY_STELEAF                 P_GEN_9_POKEMON
#define P_FAMILY_SERPARK                 P_GEN_9_POKEMON
#define P_FAMILY_TITAL                   P_GEN_9_POKEMON
#define P_FAMILY_JAEWING                 P_GEN_9_POKEMON
#define P_FAMILY_KITTUSK                 P_GEN_9_POKEMON
#define P_FAMILY_PUPVY                   P_GEN_9_POKEMON
#define P_FAMILY_DRAED                   P_GEN_9_POKEMON
#define P_FAMILY_LARVIRE                 P_GEN_9_POKEMON
#define P_FAMILY_RACTRIC                 P_GEN_9_POKEMON
#define P_FAMILY_THEIWN                  P_GEN_9_POKEMON
#define P_FAMILY_ENJEL                   P_GEN_9_POKEMON
#define P_FAMILY_GEQ                     P_GEN_9_POKEMON
#define P_FAMILY_SCECHINUS               P_GEN_9_POKEMON
#define P_FAMILY_SALLET                  P_GEN_9_POKEMON
#define P_FAMILY_FLOXIE                  P_GEN_9_POKEMON
#define P_FAMILY_LYCXY                   P_GEN_9_POKEMON
#define P_FAMILY_MESWIF                  P_GEN_9_POKEMON
#define P_FAMILY_CLAYR                   P_GEN_9_POKEMON
#define P_FAMILY_VENODEER                P_GEN_9_POKEMON
#define P_FAMILY_DISGAL                  P_GEN_9_POKEMON
#define P_FAMILY_OUROGET                 P_GEN_9_POKEMON
#define P_FAMILY_SALAIRIE                P_GEN_9_POKEMON
#define P_FAMILY_SPOOSO                  P_GEN_9_POKEMON
#define P_FAMILY_SOLFAE                  P_GEN_9_POKEMON
#define P_FAMILY_STONNY                  P_GEN_9_POKEMON
#define P_FAMILY_THOLE                   P_GEN_9_POKEMON
#define P_FAMILY_BATGEM                  P_GEN_9_POKEMON
#define P_FAMILY_MARRENGE                P_GEN_9_POKEMON
#define P_FAMILY_HORTERN                 P_GEN_9_POKEMON
#define P_FAMILY_SABONE                  P_GEN_9_POKEMON
#define P_FAMILY_NARFLOE                 P_GEN_9_POKEMON
#define P_FAMILY_WATTLANTA               P_GEN_9_POKEMON
#define P_FAMILY_TORRPHIN                P_GEN_9_POKEMON
#define P_FAMILY_SPRIORY                 P_GEN_9_POKEMON
#define P_FAMILY_SLOMOUS                 P_GEN_9_POKEMON
#define P_FAMILY_MELKADY                 P_GEN_9_POKEMON
#define P_FAMILY_KITALIS                 P_GEN_9_POKEMON
#define P_FAMILY_POLYFERN                P_GEN_9_POKEMON
#define P_FAMILY_RIDEQUIN                P_GEN_9_POKEMON
#define P_FAMILY_CASTA                   P_GEN_9_POKEMON
#define P_FAMILY_DIOD                    P_GEN_9_POKEMON
#define P_FAMILY_COYPADE                 P_GEN_9_POKEMON
#define P_FAMILY_FUGIO                   P_GEN_9_POKEMON
#define P_FAMILY_GRADET                  P_GEN_9_POKEMON
#define P_FAMILY_FLUSIC                  P_GEN_9_POKEMON
#define P_FAMILY_SALAMAGE                P_GEN_9_POKEMON
#define P_FAMILY_FLORISION               P_GEN_9_POKEMON
#define P_FAMILY_MINELLY                 P_GEN_9_POKEMON
#define P_FAMILY_COASTAWL                P_GEN_9_POKEMON
#define P_FAMILY_OSTEAM                  P_GEN_9_POKEMON
#define P_FAMILY_CATTARM                 P_GEN_9_POKEMON
#define P_FAMILY_TOAMBINA                P_GEN_9_POKEMON
#define P_FAMILY_PUPIZARD                P_GEN_9_POKEMON
#define P_FAMILY_SACYRM                  P_GEN_9_POKEMON
#define P_FAMILY_LORDRA                  P_GEN_9_POKEMON
#define P_FAMILY_GHIATMO                 P_GEN_9_POKEMON
#define P_FAMILY_SAXIFROST               P_GEN_9_POKEMON
#define P_FAMILY_CHAMICE                 P_GEN_9_POKEMON
#define P_FAMILY_SNOWPUP                 P_GEN_9_POKEMON
#define P_FAMILY_STACODE                 P_GEN_9_POKEMON
#define P_FAMILY_JUNPEAO                 P_GEN_9_POKEMON
#define P_FAMILY_MINOCTUA                P_GEN_9_POKEMON
#define P_FAMILY_JUPITOS                 P_GEN_9_POKEMON
