...
#define TEXT_SPEED_SLOW_MODIFIER     5       // How fast the SLOW text speed option prints
#define TEXT_SPEED_MEDIUM_MODIFIER   6       // How fast the MID text speed option prints
#define TEXT_SPEED_FAST_MODIFIER     7       // How fast the FAST text speed option prints
#define TEXT_SPEED_INSTANT_MODIFIER  8       // Needed only for the animation delays
