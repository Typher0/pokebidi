...
#define TEXT_SPEED_SLOW_MODIFIER     6       // How fast the SLOW text speed option prints
#define TEXT_SPEED_MEDIUM_MODIFIER   7       // How fast the MID text speed option prints
