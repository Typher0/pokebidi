...
#define MUS_ROUTE122                375 // MUS_DOORO_X4         // Also used in Route 123 and Birch's intro speech.
#define MUS_OCEANIC_MUSEUM          376 // MUS_FUNE_KAN
#define MUS_EVOLUTION_INTRO         377 // MUS_ME_SHINKA        // Also used in egg hatching.
#define MUS_EVOLUTION               378 // MUS_SHINKA           // Also used in egg hatching and trades.
#define MUS_MOVE_DELETED            379 // MUS_ME_WASURE
#define MUS_ENCOUNTER_GIRL          380 // MUS_SYOUJOEYE
#define MUS_ENCOUNTER_MALE          381 // MUS_BOYEYE
#define MUS_ABANDONED_SHIP          382 // MUS_DAN02            // Also used in Faraway and Southern Islands.
#define MUS_FORTREE                 383 // MUS_MACHI_S3         // Also used in Secret Bases and the Safari Zone's entrance.
#define MUS_BIRCH_LAB               384 // MUS_ODAMAKI
#define MUS_B_TOWER_RS              385 // MUS_B_TOWER          // Used in Battle Tents, Trainer Hill and Battle Frontier's lounges and Exchange Service Corner.
#define MUS_ENCOUNTER_SWIMMER       386 // MUS_SWIMEYE
#define MUS_CAVE_OF_ORIGIN          387 // MUS_DAN03            // Also used in Meteor Falls.
#define MUS_OBTAIN_BERRY            388 // MUS_ME_KINOMI
#define MUS_AWAKEN_LEGEND           389 // MUS_ME_TAMA
#define MUS_SLOTS_JACKPOT           390 // MUS_ME_B_BIG         // Also used in the Roulette.
#define MUS_SLOTS_WIN               391 // MUS_ME_B_SMALL       // Also used in the Roulette.
#define MUS_TOO_BAD                 392 // MUS_ME_ZANNEN
#define MUS_ROULETTE                393 // MUS_BD_TIME
#define MUS_LINK_CONTEST_P1         394 // MUS_TEST1
#define MUS_LINK_CONTEST_P2         395 // MUS_TEST2
#define MUS_LINK_CONTEST_P3         396 // MUS_TEST3
#define MUS_LINK_CONTEST_P4         397 // MUS_TEST4
#define MUS_ENCOUNTER_RICH          398 // MUS_TEST
#define MUS_VERDANTURF              399 // MUS_GOMACHI0
#define MUS_RUSTBORO                400 // MUS_GOTOWN           // Also used in Mauville City, Mossdeep City, Daycare, Weather Institute and several Route houses.
#define MUS_POKE_CENTER             401 // MUS_POKECEN          // Also used in the Pokémon League's lobby.
#define MUS_ROUTE104                402 // MUS_NEXTROAD         // Also used in Routes 105, 106, 107, 108, 109, 115 and 116.
#define MUS_ROUTE119                403 // MUS_GRANROAD         // Also used in Routes 129, 130, 131, 132, 133, 134 and 118's east half.
#define MUS_CYCLING                 404 // MUS_CYCLING
#define MUS_POKE_MART               405 // MUS_FRIENDLY         // Also used in Lilycove's Department Store.
#define MUS_LITTLEROOT              406 // MUS_MISHIRO
#define MUS_MT_CHIMNEY              407 // MUS_TOZAN            // Also used in Desert Underpass, Mirage Tower, Seafloor Cavern and Sky Pillar.
#define MUS_ENCOUNTER_FEMALE        408 // MUS_GIRLEYE
#define MUS_LILYCOVE                409 // MUS_MINAMO           // Also used in Pacifidlog Town and the Diving Treasure Hunter's house.
#define MUS_DESERT                  410 // MUS_ASHROAD
#define MUS_HELP                    411 // MUS_EVENT0
#define MUS_UNDERWATER              412 // MUS_DEEPDEEP
#define MUS_VICTORY_TRAINER         413 // MUS_KACHI1
#define MUS_TITLE                   414 // MUS_TITLE3
#define MUS_INTRO                   415 // MUS_DEMO1
#define MUS_ENCOUNTER_MAY           416 // MUS_GIRL_SUP
#define MUS_ENCOUNTER_INTENSE       417 // MUS_HAGESHII
#define MUS_ENCOUNTER_COOL          418 // MUS_KAKKOII
#define MUS_ROUTE113                419 // MUS_KAZANBAI
#define MUS_ENCOUNTER_AQUA          420 // MUS_AQA_0
#define MUS_FOLLOW_ME               421 // MUS_TSURETEK
#define MUS_ENCOUNTER_BRENDAN       422 // MUS_BOY_SUP
#define MUS_EVER_GRANDE             423 // MUS_RAINBOW          // Also used in link rooms.
#define MUS_ENCOUNTER_SUSPICIOUS    424 // MUS_AYASII
#define MUS_VICTORY_AQUA_MAGMA      425 // MUS_KACHI4
#define MUS_CABLE_CAR               426 // MUS_ROPEWAY
#define MUS_GAME_CORNER             427 // MUS_CASINO
#define MUS_DEWFORD                 428 // MUS_HIGHTOWN         // Also used in Route 109's Seashore house.
#define MUS_SAFARI_ZONE             429 // MUS_SAFARI
#define MUS_VICTORY_ROAD            430 // MUS_C_ROAD           // Also used in Pokémon League's E4/Champion rooms and halls.
#define MUS_AQUA_MAGMA_HIDEOUT      431 // MUS_AJITO
#define MUS_SAILING                 432 // MUS_M_BOAT
#define MUS_MT_PYRE                 433 // MUS_M_DUNGON         // Also used in New Mauville and Shoal Cave.
#define MUS_SLATEPORT               434 // MUS_FINECITY         // Also used in Cycling Road's entrances.
#define MUS_MT_PYRE_EXTERIOR        435 // MUS_MACHUPI
#define MUS_SCHOOL                  436 // MUS_P_SCHOOL
#define MUS_HALL_OF_FAME            437 // MUS_DENDOU
#define MUS_FALLARBOR               438 // MUS_TONEKUSA         // Also used in Route 114's houses.
#define MUS_SEALED_CHAMBER          439 // MUS_MABOROSI         // Also used in Ancient Tomb, Desert Ruins and Island Cave.
#define MUS_CONTEST_WINNER          440 // MUS_CON_FAN
#define MUS_CONTEST                 441 // MUS_CONTEST0
#define MUS_ENCOUNTER_MAGMA         442 // MUS_MGM0
#define MUS_INTRO_BATTLE            443 // MUS_T_BATTLE
#define MUS_ABNORMAL_WEATHER        444 // MUS_OOAME            // Replaces MUS_WEATHER_KYOGRE from R/S.
#define MUS_WEATHER_GROUDON         445 // MUS_HIDERI           // Unused, from R/S.
#define MUS_SOOTOPOLIS              446 // MUS_RUNECITY
#define MUS_CONTEST_RESULTS         447 // MUS_CON_K
#define MUS_HALL_OF_FAME_ROOM       448 // MUS_EIKOU_R
#define MUS_TRICK_HOUSE             449 // MUS_KARAKURI
#define MUS_ENCOUNTER_TWINS         450 // MUS_HUTAGO
#define MUS_ENCOUNTER_ELITE_FOUR    451 // MUS_SITENNOU
#define MUS_ENCOUNTER_HIKER         452 // MUS_YAMA_EYE
#define MUS_CONTEST_LOBBY           453 // MUS_CONLOBBY
#define MUS_ENCOUNTER_INTERVIEWER   454 // MUS_INTER_V          // Also used during Petalburg City report at the beginning of the game.
#define MUS_ENCOUNTER_CHAMPION      455 // MUS_DAIGO
#define MUS_CREDITS                 456 // MUS_THANKFOR
#define MUS_END                     457 // MUS_END
#define MUS_B_FRONTIER              458 // MUS_B_FRONTIER
#define MUS_B_ARENA                 459 // MUS_B_ARENA
#define MUS_OBTAIN_B_POINTS         460 // MUS_ME_POINTGET
#define MUS_REGISTER_MATCH_CALL     461 // MUS_ME_TORE_EYE
#define MUS_B_PYRAMID               462 // MUS_PYRAMID
#define MUS_B_PYRAMID_TOP           463 // MUS_PYRAMID_TOP
#define MUS_B_PALACE                464 // MUS_B_PALACE
#define MUS_RAYQUAZA_APPEARS        465 // MUS_REKKUU_KOURIN
#define MUS_B_TOWER                 466 // MUS_SATTOWER
#define MUS_OBTAIN_SYMBOL           467 // MUS_ME_SYMBOLGET
#define MUS_B_DOME                  468 // MUS_B_DOME
#define MUS_B_PIKE                  469 // MUS_B_TUBE
#define MUS_B_FACTORY               470 // MUS_B_FACTORY
#define MUS_VS_RAYQUAZA             471 // MUS_VS_REKKU         // Identical to MUS_VS_KYOGRE_GROUDON.
#define MUS_VS_FRONTIER_BRAIN       472 // MUS_VS_FRONT
#define MUS_VS_MEW                  473 // MUS_VS_MEW
#define MUS_B_DOME_LOBBY            474 // MUS_B_DOME1
#define MUS_VS_WILD                 475 // MUS_BATTLE27
#define MUS_VS_AQUA_MAGMA           476 // MUS_BATTLE31
#define MUS_VS_TRAINER              477 // MUS_BATTLE20
#define MUS_VS_GYM_LEADER           478 // MUS_BATTLE32
#define MUS_VS_CHAMPION             479 // MUS_BATTLE33
#define MUS_VS_REGI                 480 // MUS_BATTLE36
#define MUS_VS_KYOGRE_GROUDON       481 // MUS_BATTLE34
