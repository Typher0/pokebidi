...
enum StringID
{
    ...
    STRINGID_PASSIVEDRAINABSORBED,
    STRINGID_PASSIVEREPELREFLECTED,
    STRINGID_PASSIVESTEADYHEAL,
    STRINGID_PASSIVEPREVENTSSTATLOSS,
    STRINGID_PASSIVEBLOCKEDSTATUS,
    STRINGID_PASSIVECUREDSTATUS,
