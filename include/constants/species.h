...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_HAMSNUG = SPECIES_CUSTOM_START + 1,
    SPECIES_SNUGGYBARA = SPECIES_CUSTOM_START + 2,
    SPECIES_PINGLOO = SPECIES_CUSTOM_START + 3,
    SPECIES_PENGLACIER = SPECIES_CUSTOM_START + 4,
    SPECIES_CABOB = SPECIES_CUSTOM_START + 5,
    SPECIES_LYNXSKEW = SPECIES_CUSTOM_START + 6,
    SPECIES_PUMACH = SPECIES_CUSTOM_START + 7,
    SPECIES_JAGWIRE = SPECIES_CUSTOM_START + 8,
    SPECIES_SKULLARVA = SPECIES_CUSTOM_START + 9,
    SPECIES_KAKONE = SPECIES_CUSTOM_START + 10,
    SPECIES_MORTASQUE = SPECIES_CUSTOM_START + 11,
    SPECIES_TOTTER = SPECIES_CUSTOM_START + 12,
    SPECIES_CASCOTTA = SPECIES_CUSTOM_START + 13,
    SPECIES_LUTRAJET = SPECIES_CUSTOM_START + 14,
    SPECIES_TENROCK = SPECIES_CUSTOM_START + 15,
    SPECIES_SHREWEL = SPECIES_CUSTOM_START + 16,
    SPECIES_PANGOLEM = SPECIES_CUSTOM_START + 17,
    SPECIES_SHELFUR = SPECIES_CUSTOM_START + 18,
    SPECIES_IGNOISE = SPECIES_CUSTOM_START + 19,
    SPECIES_MOLTORTOISE = SPECIES_CUSTOM_START + 20,
    SPECIES_CHIHAHA = SPECIES_CUSTOM_START + 21,
    SPECIES_HOWLEQUIN = SPECIES_CUSTOM_START + 22,
    SPECIES_PALLECTRON = SPECIES_CUSTOM_START + 23,
    SPECIES_CALLUMMOTOR = SPECIES_CUSTOM_START + 24,
    SPECIES_ELECTRIOCEROS = SPECIES_CUSTOM_START + 25,
    SPECIES_CHIMPOCA = SPECIES_CUSTOM_START + 26,
    SPECIES_SIMAYAN = SPECIES_CUSTOM_START + 27,
    SPECIES_ICETOPE = SPECIES_CUSTOM_START + 28,
    SPECIES_CHILLNOBYL = SPECIES_CUSTOM_START + 29,
    SPECIES_MAGROPLEX = SPECIES_CUSTOM_START + 30,
    SPECIES_PSYYNEN = SPECIES_CUSTOM_START + 31,
    SPECIES_AANCHGORA = SPECIES_CUSTOM_START + 32,
    SPECIES_FOLTERGEIST = SPECIES_CUSTOM_START + 33,
    SPECIES_FANTASMARE = SPECIES_CUSTOM_START + 34,
    SPECIES_CUPPY = SPECIES_CUSTOM_START + 35,
    SPECIES_FETTLEKISH = SPECIES_CUSTOM_START + 36,
    SPECIES_NECTRI = SPECIES_CUSTOM_START + 37,
    SPECIES_HUMMISCUS = SPECIES_CUSTOM_START + 38,
    SPECIES_NECTRIARY = SPECIES_CUSTOM_START + 39,
    SPECIES_CARDINITE = SPECIES_CUSTOM_START + 40,
    SPECIES_CHARDINAL = SPECIES_CUSTOM_START + 41,
    SPECIES_SALAGUADE = SPECIES_CUSTOM_START + 42,
    SPECIES_IGUASH = SPECIES_CUSTOM_START + 43,
    SPECIES_JUGGERCROC = SPECIES_CUSTOM_START + 44,
    SPECIES_ARROWBIN = SPECIES_CUSTOM_START + 45,
    SPECIES_HAWTCHET = SPECIES_CUSTOM_START + 46,
    SPECIES_CHIEFTURK = SPECIES_CUSTOM_START + 47,
    SPECIES_NEUREKA = SPECIES_CUSTOM_START + 48,
    SPECIES_EDISYNAPSE = SPECIES_CUSTOM_START + 49,
    SPECIES_SCLICK = SPECIES_CUSTOM_START + 50,
    SPECIES_VECTRION = SPECIES_CUSTOM_START + 51,
    SPECIES_FAWNPIRE = SPECIES_CUSTOM_START + 52,
    SPECIES_ALPACULA = SPECIES_CUSTOM_START + 53,
    SPECIES_MOOSEFERATU = SPECIES_CUSTOM_START + 54,
    SPECIES_PLATYPOW = SPECIES_CUSTOM_START + 55,
    SPECIES_PLATYPUNCH = SPECIES_CUSTOM_START + 56,
    SPECIES_SILKINDER_MALE = SPECIES_CUSTOM_START + 57,
    SPECIES_SILKINDER = SPECIES_SILKINDER_MALE,
    SPECIES_SILKINDER_FEMALE = SPECIES_CUSTOM_START + 58,
    SPECIES_SENSILK_MALE = SPECIES_CUSTOM_START + 59,
    SPECIES_SENSILK = SPECIES_SENSILK_MALE,
    SPECIES_SENSILK_FEMALE = SPECIES_CUSTOM_START + 60,
    SPECIES_DALTOM = SPECIES_CUSTOM_START + 61,
    SPECIES_OPPENHION = SPECIES_CUSTOM_START + 62,
    SPECIES_GOLTERRA = SPECIES_CUSTOM_START + 63,
    SPECIES_GAIOLEM = SPECIES_CUSTOM_START + 64,
    SPECIES_RELLADUNE = SPECIES_CUSTOM_START + 65,
    SPECIES_CAMORELLA = SPECIES_CUSTOM_START + 66,
    SPECIES_COBOE = SPECIES_CUSTOM_START + 67,
    SPECIES_PUNGRIYADH = SPECIES_CUSTOM_START + 68,
    SPECIES_SEDIRROT = SPECIES_CUSTOM_START + 69,
    SPECIES_CONDESA = SPECIES_CUSTOM_START + 70,
    SPECIES_NOBUNATA = SPECIES_CUSTOM_START + 71,
    SPECIES_SOMBERO = SPECIES_CUSTOM_START + 72,
    SPECIES_MINARAC = SPECIES_CUSTOM_START + 73,
    SPECIES_TARENCHULA = SPECIES_CUSTOM_START + 74,
    SPECIES_CARBITE = SPECIES_CUSTOM_START + 75,
    SPECIES_PRESSAUR = SPECIES_CUSTOM_START + 76,
    SPECIES_DIAMAW = SPECIES_CUSTOM_START + 77,
    SPECIES_GILLA = SPECIES_CUSTOM_START + 78,
    SPECIES_ANODONTOR = SPECIES_CUSTOM_START + 79,
    SPECIES_ANKILLOSAUR = SPECIES_CUSTOM_START + 80,
    SPECIES_BAZILISK = SPECIES_CUSTOM_START + 81,
    SPECIES_ORNITHAUR = SPECIES_CUSTOM_START + 82,
    SPECIES_DILOPHLORA = SPECIES_CUSTOM_START + 83,
    SPECIES_SQUIBBLE = SPECIES_CUSTOM_START + 84,
    SPECIES_SQUINGO = SPECIES_CUSTOM_START + 85,
    SPECIES_DRAKNARR = SPECIES_CUSTOM_START + 86,
    SPECIES_RAGNAROW = SPECIES_CUSTOM_START + 87,
    SPECIES_MANDALLOY = SPECIES_CUSTOM_START + 88,
    SPECIES_PHLASK = SPECIES_CUSTOM_START + 89,
    SPECIES_NOXIGHAST_MALE = SPECIES_CUSTOM_START + 90,
    SPECIES_NOXIGHAST = SPECIES_NOXIGHAST_MALE,
    SPECIES_NOXIGHAST_FEMALE = SPECIES_CUSTOM_START + 91,
    SPECIES_FUMIGHAST_MALE = SPECIES_CUSTOM_START + 92,
    SPECIES_FUMIGHAST = SPECIES_FUMIGHAST_MALE,
    SPECIES_FUMIGHAST_FEMALE = SPECIES_CUSTOM_START + 93,
    SPECIES_PINECALF = SPECIES_CUSTOM_START + 94,
    SPECIES_TRUNKONIFR = SPECIES_CUSTOM_START + 95,
    SPECIES_MASKREEP = SPECIES_CUSTOM_START + 96,
    SPECIES_PHANTIKI = SPECIES_CUSTOM_START + 97,
    SPECIES_TAOMARIN = SPECIES_CUSTOM_START + 98,
    SPECIES_ORANGUTAO = SPECIES_CUSTOM_START + 99,
    SPECIES_COALT = SPECIES_CUSTOM_START + 100,
    SPECIES_ARIESKORCH = SPECIES_CUSTOM_START + 101,
    SPECIES_BLUFFIN = SPECIES_CUSTOM_START + 102,
    SPECIES_SKARPIE = SPECIES_CUSTOM_START + 103,
    SPECIES_GNOWM = SPECIES_CUSTOM_START + 104,
    SPECIES_SNOWGRE = SPECIES_CUSTOM_START + 105,
    SPECIES_BOAREALIS = SPECIES_CUSTOM_START + 106,
    SPECIES_WISHP = SPECIES_CUSTOM_START + 107,
    SPECIES_IGFRIT = SPECIES_CUSTOM_START + 108,
    SPECIES_DJINNFERNO = SPECIES_CUSTOM_START + 109,
    SPECIES_MOONIGHT = SPECIES_CUSTOM_START + 110,
    SPECIES_JOUSTOCK = SPECIES_CUSTOM_START + 111,
    SPECIES_CRUSABER = SPECIES_CUSTOM_START + 112,
    SPECIES_CHELONITE = SPECIES_CUSTOM_START + 113,
    SPECIES_GALAXAGOS = SPECIES_CUSTOM_START + 114,
    SPECIES_TANUKOON = SPECIES_CUSTOM_START + 115,
    SPECIES_LEUKOON = SPECIES_CUSTOM_START + 116,
    SPECIES_CACTURADO = SPECIES_CUSTOM_START + 117,
    SPECIES_ESOTEROWN = SPECIES_CUSTOM_START + 118,
    SPECIES_DOCTOWL = SPECIES_CUSTOM_START + 119,
    SPECIES_SILVALLY_SOUND = SPECIES_CUSTOM_START + 120,
    SPECIES_ARCEUS_SOUND = SPECIES_CUSTOM_START + 121,
    SPECIES_HATHROSTUS = SPECIES_CUSTOM_START + 122,
    SPECIES_BABOSIRIS = SPECIES_CUSTOM_START + 123,
    SPECIES_HUBRISET = SPECIES_CUSTOM_START + 124,
    SPECIES_WENDINGO = SPECIES_CUSTOM_START + 125,
    SPECIES_ROYGIBIV = SPECIES_CUSTOM_START + 126,
    SPECIES_TYPHLOSION_MEGA = SPECIES_CUSTOM_START + 127,
    SPECIES_EXPLOUD_MEGA = SPECIES_CUSTOM_START + 128,
    SPECIES_TORTERRA_MEGA = SPECIES_CUSTOM_START + 129,
    SPECIES_INFERNAPE_MEGA = SPECIES_CUSTOM_START + 130,
    SPECIES_EMPOLEON_MEGA = SPECIES_CUSTOM_START + 131,
    SPECIES_MAMOSWINE_MEGA = SPECIES_CUSTOM_START + 132,
    SPECIES_DUSKNOIR_MEGA = SPECIES_CUSTOM_START + 133,
    SPECIES_MUSHARNA_MEGA = SPECIES_CUSTOM_START + 134,
    SPECIES_GIGALITH_MEGA = SPECIES_CUSTOM_START + 135,
    SPECIES_COFAGRIGUS_MEGA = SPECIES_CUSTOM_START + 136,
    SPECIES_PORYGON_Z_MEGA = SPECIES_CUSTOM_START + 137,
    SPECIES_XERNEAS_PRIMAL = SPECIES_CUSTOM_START + 138,
    SPECIES_YVELTAL_PRIMAL = SPECIES_CUSTOM_START + 139,
    SPECIES_CUSTOM_END,
