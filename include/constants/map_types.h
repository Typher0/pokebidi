...
enum MapType
{
    ...
    MAP_TYPE_CITY,
    MAP_TYPE_ROUTE,
    MAP_TYPE_ROUTE_SNOWY,
    MAP_TYPE_ROUTE_DESERT,
    MAP_TYPE_SWAMP,
    MAP_TYPE_SAFARI,
    MAP_TYPE_CRAG,
    MAP_TYPE_AUTUMN,
    MAP_TYPE_MOUNTAIN_BROWN,
    MAP_TYPE_MOUNTAIN_SNOWY,
    MAP_TYPE_MOUNTAIN_GRAY,
    MAP_TYPE_MOUNTAIN_VOLCANO,
    MAP_TYPE_UNDERGROUND,
    MAP_TYPE_UNDERGROUND_GRAY,
    MAP_TYPE_UNDERGROUND_SNOWY,
    MAP_TYPE_UNDERGROUND_MAGMA,
    MAP_TYPE_UNDERWATER,
