...
static const u16 sTrainerTowerEncounterMusic[] = {
    [TRAINER_ENCOUNTER_MUSIC_MALE]        = MUS_DP_ENCOUNTER_BOY,
    [TRAINER_ENCOUNTER_MUSIC_FEMALE]      = MUS_DP_ENCOUNTER_GIRL,
    [TRAINER_ENCOUNTER_MUSIC_GIRL]        = MUS_DP_ENCOUNTER_GIRL,
    [TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS]  = MUS_DP_ENCOUNTER_SUSPICIOUS,
    [TRAINER_ENCOUNTER_MUSIC_INTENSE]     = MUS_DP_ENCOUNTER_INTENSE,
    [TRAINER_ENCOUNTER_MUSIC_COOL]        = MUS_DP_ENCOUNTER_ACE_TRAINER,
    [TRAINER_ENCOUNTER_MUSIC_AQUA]        = MUS_DP_ENCOUNTER_GALACTIC,
    [TRAINER_ENCOUNTER_MUSIC_MAGMA]       = MUS_HG_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_SWIMMER]     = MUS_DP_ENCOUNTER_BOY,
    [TRAINER_ENCOUNTER_MUSIC_TWINS]       = MUS_DP_ENCOUNTER_TWINS,
    [TRAINER_ENCOUNTER_MUSIC_ELITE_FOUR]  = MUS_DP_ENCOUNTER_ELITE_FOUR,
    [TRAINER_ENCOUNTER_MUSIC_HIKER]       = MUS_DP_ENCOUNTER_HIKER,
    [TRAINER_ENCOUNTER_MUSIC_INTERVIEWER] = MUS_DP_ENCOUNTER_BOY,
    [TRAINER_ENCOUNTER_MUSIC_RICH]        = MUS_DP_ENCOUNTER_RICH
};
