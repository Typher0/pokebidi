...
{
    [BATTLE_ENVIRONMENT_ARENA]            = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST]    = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST_E]  = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST_N]  = MOVE_ENERGY_BALL,
    [BATTLE_ENVIRONMENT_BEACH]            = MOVE_MUDDY_WATER,
    [BATTLE_ENVIRONMENT_BEACH_E]          = MOVE_MUDDY_WATER,
    [BATTLE_ENVIRONMENT_BEACH_N]          = MOVE_MUDDY_WATER,
    [BATTLE_ENVIRONMENT_BRIDGE]           = MOVE_BRICK_BREAK,
    [BATTLE_ENVIRONMENT_BRIDGE_E]         = MOVE_BRICK_BREAK,
    [BATTLE_ENVIRONMENT_BRIDGE_N]         = MOVE_BRICK_BREAK,
    [BATTLE_ENVIRONMENT_CAVE]             = MOVE_POWER_GEM,
    [BATTLE_ENVIRONMENT_CAVE_DARK]        = MOVE_ANCIENT_POWER,
    [BATTLE_ENVIRONMENT_CAVE_MAGMA]       = MOVE_ERUPTION,
    [BATTLE_ENVIRONMENT_CAVE_SNOW]        = MOVE_ICICLE_CRASH,
    [BATTLE_ENVIRONMENT_CITY]             = MOVE_BODY_SLAM,
    [BATTLE_ENVIRONMENT_CITY_E]           = MOVE_BODY_SLAM,
    [BATTLE_ENVIRONMENT_CITY_N]           = MOVE_BODY_SLAM,
    [BATTLE_ENVIRONMENT_CRAG]             = MOVE_AIR_SLASH,
    [BATTLE_ENVIRONMENT_CRAG_E]           = MOVE_AIR_SLASH,
    [BATTLE_ENVIRONMENT_CRAG_N]           = MOVE_AIR_SLASH,
    [BATTLE_ENVIRONMENT_DESERT]           = MOVE_SCORCHING_SANDS,
    [BATTLE_ENVIRONMENT_DESERT_E]         = MOVE_SCORCHING_SANDS,
    [BATTLE_ENVIRONMENT_DESERT_N]         = MOVE_SCORCHING_SANDS,
    [BATTLE_ENVIRONMENT_GWEN]             = MOVE_TERA_BLAST,
    [BATTLE_ENVIRONMENT_GYM]              = MOVE_CHIP_AWAY,
    [BATTLE_ENVIRONMENT_INDOOR]           = MOVE_TRI_ATTACK,
    [BATTLE_ENVIRONMENT_MOOSE]            = MOVE_FLARE_BLITZ,
    [BATTLE_ENVIRONMENT_MOUNTAIN]         = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_E]       = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_N]       = MOVE_ROCK_SLIDE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW]    = MOVE_AVALANCHE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW_E]  = MOVE_AVALANCHE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW_N]  = MOVE_AVALANCHE,
    [BATTLE_ENVIRONMENT_ROCKY]            = MOVE_STONE_EDGE,
    [BATTLE_ENVIRONMENT_ROCKY_E]          = MOVE_STONE_EDGE,
    [BATTLE_ENVIRONMENT_ROCKY_N]          = MOVE_STONE_EDGE,
    [BATTLE_ENVIRONMENT_ROUTE]            = MOVE_TRAILBLAZE,
    [BATTLE_ENVIRONMENT_ROUTE_E]          = MOVE_TRAILBLAZE,
    [BATTLE_ENVIRONMENT_ROUTE_N]          = MOVE_TRAILBLAZE,
    [BATTLE_ENVIRONMENT_SAFARI]           = MOVE_GRASSY_GLIDE,
    [BATTLE_ENVIRONMENT_SAFARI_E]         = MOVE_GRASSY_GLIDE,
    [BATTLE_ENVIRONMENT_SAFARI_N]         = MOVE_GRASSY_GLIDE,
    [BATTLE_ENVIRONMENT_SEA]              = MOVE_SURF,
    [BATTLE_ENVIRONMENT_SEA_E]            = MOVE_SURF,
    [BATTLE_ENVIRONMENT_SEA_N]            = MOVE_SURF,
    [BATTLE_ENVIRONMENT_SNOW]             = MOVE_BLIZZARD,
    [BATTLE_ENVIRONMENT_SWAMP]            = MOVE_MUD_BOMB,
    [BATTLE_ENVIRONMENT_SWAMP_E]          = MOVE_MUD_BOMB,
    [BATTLE_ENVIRONMENT_SWAMP_N]          = MOVE_MUD_BOMB,
    [BATTLE_ENVIRONMENT_SNOW_E]           = MOVE_BLIZZARD,
    [BATTLE_ENVIRONMENT_SNOW_N]           = MOVE_BLIZZARD,
    [BATTLE_ENVIRONMENT_THOMAS]           = MOVE_AERIAL_ACE,
    [BATTLE_ENVIRONMENT_TINKER]           = MOVE_FLASH_CANNON,
    [BATTLE_ENVIRONMENT_TOBIAS]           = MOVE_FOUL_PLAY,
    [BATTLE_ENVIRONMENT_UNDERWATER]       = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_UNDERWATER_E]     = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_UNDERWATER_N]     = MOVE_HYDRO_PUMP,
    [BATTLE_ENVIRONMENT_VOLCANO]          = MOVE_LAVA_PLUME,
    [BATTLE_ENVIRONMENT_VOLCANO_E]        = MOVE_LAVA_PLUME,
    [BATTLE_ENVIRONMENT_VOLCANO_N]        = MOVE_LAVA_PLUME,
};
...
{
    [BATTLE_ENVIRONMENT_ARENA]            = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST]    = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST_E]  = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_AUTUMN_FOREST_N]  = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_BEACH]            = TYPE_WATER,
    [BATTLE_ENVIRONMENT_BEACH_E]          = TYPE_WATER,
    [BATTLE_ENVIRONMENT_BEACH_N]          = TYPE_WATER,
    [BATTLE_ENVIRONMENT_BRIDGE]           = TYPE_WATER,
    [BATTLE_ENVIRONMENT_BRIDGE_E]         = TYPE_WATER,
    [BATTLE_ENVIRONMENT_BRIDGE_N]         = TYPE_WATER,
    [BATTLE_ENVIRONMENT_CAVE]             = TYPE_ROCK,
    [BATTLE_ENVIRONMENT_CAVE_DARK]        = TYPE_ROCK,
    [BATTLE_ENVIRONMENT_CAVE_MAGMA]       = TYPE_FIRE,
    [BATTLE_ENVIRONMENT_CAVE_SNOW]        = TYPE_ICE,
    [BATTLE_ENVIRONMENT_CITY]             = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_CITY_E]           = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_CITY_N]           = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_CRAG]             = TYPE_FLYING,
    [BATTLE_ENVIRONMENT_CRAG_E]           = TYPE_FLYING,
    [BATTLE_ENVIRONMENT_CRAG_N]           = TYPE_FLYING,
    [BATTLE_ENVIRONMENT_DESERT]           = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_DESERT_E]         = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_DESERT_N]         = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_GWEN]             = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_GYM]              = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_INDOOR]           = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_LAB]              = TYPE_NORMAL,
    [BATTLE_ENVIRONMENT_MOOSE]            = TYPE_FIRE,
    [BATTLE_ENVIRONMENT_MOUNTAIN]         = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_MOUNTAIN_E]       = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_MOUNTAIN_N]       = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW]    = TYPE_ICE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW_E]  = TYPE_ICE,
    [BATTLE_ENVIRONMENT_MOUNTAIN_SNOW_N]  = TYPE_ICE,
    [BATTLE_ENVIRONMENT_ROCKY]            = TYPE_ROCK,
    [BATTLE_ENVIRONMENT_ROCKY_E]          = TYPE_ROCK,
    [BATTLE_ENVIRONMENT_ROCKY_N]          = TYPE_ROCK,
    [BATTLE_ENVIRONMENT_ROUTE]            = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_ROUTE_E]          = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_ROUTE_N]          = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_SAFARI]           = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_SAFARI_E]         = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_SAFARI_N]         = TYPE_GRASS,
    [BATTLE_ENVIRONMENT_SEA]              = TYPE_WATER,
    [BATTLE_ENVIRONMENT_SEA_E]            = TYPE_WATER,
    [BATTLE_ENVIRONMENT_SEA_N]            = TYPE_WATER,
    [BATTLE_ENVIRONMENT_SNOW]             = TYPE_ICE,
    [BATTLE_ENVIRONMENT_SNOW_E]           = TYPE_ICE,
    [BATTLE_ENVIRONMENT_SNOW_N]           = TYPE_ICE,
    [BATTLE_ENVIRONMENT_SWAMP]            = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_SWAMP_E]          = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_SWAMP_N]          = TYPE_GROUND,
    [BATTLE_ENVIRONMENT_THOMAS]           = TYPE_FLYING,
    [BATTLE_ENVIRONMENT_TINKER]           = TYPE_STEEL,
    [BATTLE_ENVIRONMENT_TOBIAS]           = TYPE_GHOST,
    [BATTLE_ENVIRONMENT_UNDERWATER]       = TYPE_WATER,
    [BATTLE_ENVIRONMENT_UNDERWATER_E]     = TYPE_WATER,
    [BATTLE_ENVIRONMENT_UNDERWATER_N]     = TYPE_WATER,
    [BATTLE_ENVIRONMENT_VOLCANO]          = TYPE_FIRE,
    [BATTLE_ENVIRONMENT_VOLCANO_E]        = TYPE_FIRE,
    [BATTLE_ENVIRONMENT_VOLCANO_N]        = TYPE_FIRE,
};
...
bool32 IsMovePowderBlocked(u32 battlerAtk, u32 battlerDef, u32 move)
{
    ...
    if (IsPowderMove(move) && (battlerAtk != battlerDef))
    {
        if (B_POWDER_GRASS >= GEN_6
         && (IS_BATTLER_OF_TYPE(battlerDef, TYPE_GRASS) || GetBattlerAbility(battlerDef) == ABILITY_OVERCOAT || GetBattlerAbility(battlerDef) == ABILITY_COZY))
        {
            gBattlerAbility = battlerDef;
            RecordAbilityBattle(gBattlerTarget, ABILITY_OVERCOAT || ABILITY_COZY);
            effect = TRUE;
        }
    ...
    case ABILITY_BEAST_BOOST:
        {
            ...
            else if (abilityAtk == ABILITY_GRIM_NEIGH || abilityAtk == ABILITY_AS_ONE_SHADOW_RIDER || abilityAtk == ABILITY_NARCISSIST)
                stat = STAT_SPATK;
