...
const u8 gText_LilycoveCity[] = _("Joridan City");
...
const u8 gText_SavingDontTurnOff2[] = _("Saving a lot of data…\nDon't turn off the power.");
...
const u8 gText_DexHoenn[] = _("Banjime");
...
const u8 gText_TellHimTheWords[] = _("Tell him the words. Now.");
