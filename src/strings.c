...
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Unicorn");
...
const u8 gText_MainMenuMysteryEvents[] = _("Mystry Events");
...
const u8 gText_BirchInTrouble[] = _("Select a Pokémon!");
...
const u8 gText_ContestMoves[] = _("Contests Moves");
...
const u8 gText_DepositItem[] = _("Desposit Item");
...
const u8 gText_Protein1000[] = _("Protien{CLEAR_TO 99}{FONT_SMALL}1,000");
...
const u8 gText_DepositPokemon[] = _("Desposit Pokémon");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Banjime region.");
...
const u8 gText_Protein1BP[] = _("Protien{CLEAR_TO 0x64}1BP");
...
const u8 gText_KingsRock64BP[] = _("King's ROock{CLEAR_TO 0x5E}64BP");
