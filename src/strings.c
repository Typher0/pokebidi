...
const u8 gText_DexHoennTitle[] = _("Banjime Dex");
...
const u8 gText_DexHoennDescription[] = _("Banjime region's Pokédex");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pProf. Unicorn's Pokédex rating!\pProf. Unicorn: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("Saving a lot of data…\nDon't turn off the power.");
...
const u8 gText_BirchInTrouble[] = _("Prof. Unicorn is in trouble!\nRelease a Pokémon and rescue him!");
...
ALIGNED(4) const u8 gText_OtherTrainerCantAcceptPkmn[] = _("The other tainer can't accept\nthat Pokémon now.");
...
const u8 gText_SlateportCity[] = _("Arkane City");
...
const u8 gText_PokemonMaleLv[] = _("{DYNAMIC 0}{BACKGROUND TRANSPARENT}{TEXT_COLORS LIGHT_RED GREEN WHITE}♂{BACKGROUND TRANSPARENT}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonFemaleLv[] = _("{DYNAMIC 0}{BACKGROUND TRANSPARENT}{TEXT_COLORS LIGHT_GREEN BLUE WHITE}♀{BACKGROUND TRANSPARENT}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonNoGenderLv[] = _("{DYNAMIC 0}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonMaleLv2[] = _("{DYNAMIC 0}{BACKGROUND TRANSPARENT}{TEXT_COLORS LIGHT_RED GREEN WHITE}♂{BACKGROUND TRANSPARENT}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonFemaleLv2[] = _("{DYNAMIC 0}{BACKGROUND TRANSPARENT}{TEXT_COLORS LIGHT_GREEN BLUE WHITE}♀{BACKGROUND TRANSPARENT}{TEXT_COLORS DARK_GRAY LIGHT_GRAY WHITE}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
...
const u8 gText_LinkCableBattles[] = _("Local Battles");
...
const u8 gText_SavingDontTurnOff_Chat[] = _("Saving a lot of data…\nDon't turn off the power.");
...
const u8 gText_Hoenn[] = _("Banjime");
