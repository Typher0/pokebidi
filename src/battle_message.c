...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PASSIVEDRAINABSORBED]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s Passive drained the attack!"),
    [STRINGID_PASSIVEREPELREFLECTED]                = COMPOUND_STRING("{B_CURRENT_MOVE} was reflected back at {B_ATK_NAME_WITH_PREFIX}!"),
    [STRINGID_PASSIVESTEADYHEAL]                    = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} regained health from its Passive!"),
    [STRINGID_PASSIVEPREVENTSSTATLOSS]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s Passive kept its stats from falling!"),
    [STRINGID_PASSIVEBLOCKEDSTATUS]                 = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s Passive blocked the status condition!"),
    [STRINGID_PASSIVECUREDSTATUS]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} was cured of all its status conditions!"),
