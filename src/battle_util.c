...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Sound
    ...
    [TYPE_GRASS]    = {______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, ______, X(2.0)},
    ...
    [TYPE_SOUND]    = {______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, X(0.5), ______, ______, X(2.0), ______},
};
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    if (gMovesInfo[move].effect == EFFECT_FREEZE_DRY && defType == TYPE_WATER)
        mod = UQ_4_12(2.0);
    if (gMovesInfo[move].effect == EFFECT_EXORCISM && defType == TYPE_GHOST)
        mod = UQ_4_12(2.0);
    if (gMovesInfo[move].effect == EFFECT_INSECTICIDE && defType == TYPE_BUG)
        mod = UQ_4_12(2.0);
