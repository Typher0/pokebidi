...
static const struct Fanfare sFanfares[] = {
    [FANFARE_LEVEL_UP]            = { MUS_DP_LEVEL_UP,              60  },
    [FANFARE_OBTAIN_ITEM]         = { MUS_DP_OBTAIN_ITEM,           120 },
    [FANFARE_EVOLVED]             = { MUS_DP_EVOLVED,               240 },
    [FANFARE_OBTAIN_TMHM]         = { MUS_DP_OBTAIN_TMHM,           170 },
    [FANFARE_HEAL]                = { MUS_DP_HEAL,                  130 },
    [FANFARE_OBTAIN_BADGE]        = { MUS_DP_OBTAIN_BADGE,          280 },
    [FANFARE_MOVE_DELETED]        = { MUS_DP_MOVE_DELETED,          125 },
    [FANFARE_OBTAIN_BERRY]        = { MUS_DP_OBTAIN_BERRY,          90  },
    [FANFARE_AWAKEN_LEGEND]       = { MUS_DP_LEGEND_APPEARS,        1995 },
    [FANFARE_SLOTS_JACKPOT]       = { MUS_DP_SLOTS_JACKPOT,         715 },
    [FANFARE_SLOTS_WIN]           = { MUS_DP_SLOTS_WIN,             900 },
    [FANFARE_TOO_BAD]             = { MUS_DP_TV_END,                230 },
    [FANFARE_RG_POKE_FLUTE]       = { MUS_HG_RADIO_POKE_FLUTE,      1890 },
    [FANFARE_RG_OBTAIN_KEY_ITEM]  = { MUS_DP_OBTAIN_KEY_ITEM,       130 },
    [FANFARE_RG_DEX_RATING]       = { MUS_DP_DEX_RATING,            150 },
    [FANFARE_OBTAIN_B_POINTS]     = { MUS_PL_OBTAIN_B_POINTS,       235 },
    [FANFARE_OBTAIN_SYMBOL]       = { MUS_DP_OBTAIN_ACCESSORY,      145 },
    [FANFARE_REGISTER_MATCH_CALL] = { MUS_HG_POKEGEAR_REGISTERED,   150 },
};
