...
static const struct Fanfare sFanfares[] = {
    [FANFARE_LEVEL_UP]            = { MUS_DP_LEVEL_UP,              42  },
    [FANFARE_OBTAIN_ITEM]         = { MUS_DP_OBTAIN_ITEM,           108 },
    [FANFARE_EVOLVED]             = { MUS_DP_EVOLVED,               239 },
    [FANFARE_OBTAIN_TMHM]         = { MUS_DP_OBTAIN_TMHM,           161 },
    [FANFARE_HEAL]                = { MUS_DP_HEAL,                  113 },
    [FANFARE_OBTAIN_BADGE]        = { MUS_DP_OBTAIN_BADGE,          269 },
    [FANFARE_MOVE_DELETED]        = { MUS_DP_MOVE_DELETED,          113 },
    [FANFARE_OBTAIN_BERRY]        = { MUS_DP_OBTAIN_BERRY,          72  },
    [FANFARE_AWAKEN_LEGEND]       = { MUS_DP_LEGEND_APPEARS,        1995 },
    [FANFARE_SLOTS_JACKPOT]       = { MUS_DP_SLOTS_JACKPOT,         711 },
    [FANFARE_SLOTS_WIN]           = { MUS_DP_SLOTS_WIN,             896 },
    [FANFARE_TOO_BAD]             = { MUS_DP_TV_END,                227 },
    [FANFARE_RG_POKE_FLUTE]       = { MUS_HG_RADIO_POKE_FLUTE,      1887 },
    [FANFARE_RG_OBTAIN_KEY_ITEM]  = { MUS_DP_OBTAIN_KEY_ITEM,       119 },
    [FANFARE_RG_DEX_RATING]       = { MUS_DP_DEX_RATING,            149 },
    [FANFARE_OBTAIN_B_POINTS]     = { MUS_PL_OBTAIN_B_POINTS,       233 },
    [FANFARE_OBTAIN_SYMBOL]       = { MUS_DP_OBTAIN_ACCESSORY,      143 },
    [FANFARE_REGISTER_MATCH_CALL] = { MUS_HG_POKEGEAR_REGISTERED,   149 },
};
