...
static const u8 *const sMalePresetNames[] = {
    ...
    COMPOUND_STRING("Callum"),
    COMPOUND_STRING("Aidan"),
    COMPOUND_STRING("Kaleb"),
    COMPOUND_STRING("Kieran"),
    COMPOUND_STRING("Thomas"),
    COMPOUND_STRING("Matt"),
    COMPOUND_STRING("Israel"),
    COMPOUND_STRING("Salim"),
    COMPOUND_STRING("Daniel"),
    COMPOUND_STRING("Tim"),
    COMPOUND_STRING("Alex"),
    COMPOUND_STRING("Tyler")
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("Wiffle"),
    COMPOUND_STRING("Dawn"),
    COMPOUND_STRING("Serena"),
    ...
    COMPOUND_STRING("Nat"),
    COMPOUND_STRING("Jasmine"),
    COMPOUND_STRING("Bertie"),
