...
// For interacting with a headbutt tree in the field, see EventScript_Headbutt
bool32 SetUpFieldMove_Headbutt(void)
{
    if (CheckObjectGraphicsInFrontOfPlayer(MB_HEADBUTT) == TRUE)
    {
...
// The actual headbutting is handled by EventScript_Headbutt, so this function does very little
static void FieldMove_Headbutt(void)
{
