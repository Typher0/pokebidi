...
{
    HOENN_TO_NATIONAL(STELEAF),
    HOENN_TO_NATIONAL(TREASOL),
    HOENN_TO_NATIONAL(KAMAIREST),
    HOENN_TO_NATIONAL(SERPARK),
    HOENN_TO_NATIONAL(ASPYRE),
    HOENN_TO_NATIONAL(BRUCIAENA),
    HOENN_TO_NATIONAL(TITAL),
    HOENN_TO_NATIONAL(NAPARSEA),
    HOENN_TO_NATIONAL(DAHOON),
    HOENN_TO_NATIONAL(JAEWING),
    HOENN_TO_NATIONAL(MISJAE),
    HOENN_TO_NATIONAL(FOJAE),
    HOENN_TO_NATIONAL(KITTUSK),
    HOENN_TO_NATIONAL(FELIGN),
    HOENN_TO_NATIONAL(PUPVY),
    HOENN_TO_NATIONAL(HEDOG),
    HOENN_TO_NATIONAL(DRAED),
    HOENN_TO_NATIONAL(DARTLET),
    HOENN_TO_NATIONAL(ICHAR),
    HOENN_TO_NATIONAL(LARVIRE),
    HOENN_TO_NATIONAL(PUPAME),
    HOENN_TO_NATIONAL(MAGMANT),
    HOENN_TO_NATIONAL(RACTRIC),
    HOENN_TO_NATIONAL(ELECCOON),
    HOENN_TO_NATIONAL(COOVEN),
    HOENN_TO_NATIONAL(THEIWN),
    HOENN_TO_NATIONAL(MORNJA),
    HOENN_TO_NATIONAL(SUNOBI),
    HOENN_TO_NATIONAL(SHUPPET),
    HOENN_TO_NATIONAL(BANETTE),
    HOENN_TO_NATIONAL(ENJEL),
    HOENN_TO_NATIONAL(CHERUEL),
    HOENN_TO_NATIONAL(SERANE),
    HOENN_TO_NATIONAL(DAIELL),
    HOENN_TO_NATIONAL(GEQ),
    HOENN_TO_NATIONAL(GECHO),
    HOENN_TO_NATIONAL(SCECHINUS),
    HOENN_TO_NATIONAL(SALTERIX),
    HOENN_TO_NATIONAL(SALIPOTYPH),
    HOENN_TO_NATIONAL(SALLET),
    HOENN_TO_NATIONAL(XIPHIFE),
    HOENN_TO_NATIONAL(GILLIER),
    HOENN_TO_NATIONAL(CUPPY),
    HOENN_TO_NATIONAL(FETTLEKISH),
    HOENN_TO_NATIONAL(FLOXIE),
    HOENN_TO_NATIONAL(PETHIC),
    HOENN_TO_NATIONAL(LYCXY),
    HOENN_TO_NATIONAL(PUMACH),
    HOENN_TO_NATIONAL(JAGWIRE),
    HOENN_TO_NATIONAL(PLUSLE),
    HOENN_TO_NATIONAL(MULTISLE),
    HOENN_TO_NATIONAL(MINUN),
    HOENN_TO_NATIONAL(DIVISUN),
    HOENN_TO_NATIONAL(MESWIF),
    HOENN_TO_NATIONAL(CLAYR),
    HOENN_TO_NATIONAL(VENODEER),
    HOENN_TO_NATIONAL(MUNJINIDE),
    HOENN_TO_NATIONAL(COBOE),
    HOENN_TO_NATIONAL(PUNGRIYADH),
    HOENN_TO_NATIONAL(DISGAL),
    HOENN_TO_NATIONAL(JASKAL),
    HOENN_TO_NATIONAL(OUROGET),
    HOENN_TO_NATIONAL(SALAIRIE),
    HOENN_TO_NATIONAL(FAEGON),
    HOENN_TO_NATIONAL(FAEKE),
    HOENN_TO_NATIONAL(MASKREEP),
    HOENN_TO_NATIONAL(PHANTIKI),
    HOENN_TO_NATIONAL(SPOOSO),
    HOENN_TO_NATIONAL(ARCTER),
    HOENN_TO_NATIONAL(SOLFAE),
    HOENN_TO_NATIONAL(FAELAR),
    HOENN_TO_NATIONAL(NECTRI),
    HOENN_TO_NATIONAL(HUMMISCUS),
    HOENN_TO_NATIONAL(NECTRIARY),
    HOENN_TO_NATIONAL(STONNY),
    HOENN_TO_NATIONAL(ROKHARE),
    HOENN_TO_NATIONAL(BUNNULDER),
    HOENN_TO_NATIONAL(THOLE),
    HOENN_TO_NATIONAL(BADGEROSE),
    HOENN_TO_NATIONAL(BATGEM),
    HOENN_TO_NATIONAL(VAMPRISM),
    HOENN_TO_NATIONAL(MARRENGE),
    HOENN_TO_NATIONAL(VULCASS),
    HOENN_TO_NATIONAL(OSSIFLY),
    HOENN_TO_NATIONAL(SHELFUR),
    HOENN_TO_NATIONAL(IGNOISE),
    HOENN_TO_NATIONAL(MOLTORTOISE),
    HOENN_TO_NATIONAL(MINARAC),
    HOENN_TO_NATIONAL(TARENCHULA),
    HOENN_TO_NATIONAL(HORTERN),
    HOENN_TO_NATIONAL(TRICERAM),
    HOENN_TO_NATIONAL(SABONE),
    HOENN_TO_NATIONAL(SMILOTON),
    HOENN_TO_NATIONAL(NARFLOE),
    HOENN_TO_NATIONAL(WATTLANTA),
    HOENN_TO_NATIONAL(TORRPHIN),
    HOENN_TO_NATIONAL(BLUFFIN),
    HOENN_TO_NATIONAL(SKARPIE),
    HOENN_TO_NATIONAL(LAMPAE),
    HOENN_TO_NATIONAL(VOLBEAT),
    HOENN_TO_NATIONAL(COLEOPLY),
    HOENN_TO_NATIONAL(ILLUMISE),
    HOENN_TO_NATIONAL(PHOTALE),
    HOENN_TO_NATIONAL(SPRIORY),
    HOENN_TO_NATIONAL(PAXTIE),
    HOENN_TO_NATIONAL(STEORI),
    HOENN_TO_NATIONAL(SLOMOUS),
    HOENN_TO_NATIONAL(KILLORIS),
    HOENN_TO_NATIONAL(MELKADY),
    HOENN_TO_NATIONAL(KITALIS),
    HOENN_TO_NATIONAL(DIGITOX),
    HOENN_TO_NATIONAL(CARDINITE),
    HOENN_TO_NATIONAL(CHARDINAL),
    HOENN_TO_NATIONAL(POLYFERN),
    HOENN_TO_NATIONAL(SWORITUM),
    HOENN_TO_NATIONAL(RELLADUNE),
    HOENN_TO_NATIONAL(CAMORELLA),
    HOENN_TO_NATIONAL(RIDEQUIN),
    HOENN_TO_NATIONAL(EQURIOR),
    HOENN_TO_NATIONAL(STALLIOT),
    HOENN_TO_NATIONAL(CASTA),
    HOENN_TO_NATIONAL(COCCOODLE),
    HOENN_TO_NATIONAL(BUGHETTI),
    HOENN_TO_NATIONAL(DIOD),
    HOENN_TO_NATIONAL(TOOCK),
    HOENN_TO_NATIONAL(KRONSTRUC),
    HOENN_TO_NATIONAL(COYPADE),
    HOENN_TO_NATIONAL(NUTRIG),
    HOENN_TO_NATIONAL(FUGIO),
    HOENN_TO_NATIONAL(WELDIUS),
    HOENN_TO_NATIONAL(SWORGE),
    HOENN_TO_NATIONAL(MOONIGHT),
    HOENN_TO_NATIONAL(JOUSTOCK),
    HOENN_TO_NATIONAL(CRUSABER),
    ...
    HOENN_TO_NATIONAL(CHELONITE),
    HOENN_TO_NATIONAL(GALAXAGOS),
    ...
    HOENN_TO_NATIONAL(HATHROSTUS),
    HOENN_TO_NATIONAL(BABOSIRIS),
    HOENN_TO_NATIONAL(HUBRISET),
    HOENN_TO_NATIONAL(ROYGIBIV),
    HOENN_TO_NATIONAL(WENDINGO),
};
