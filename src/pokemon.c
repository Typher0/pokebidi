...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(HAMSNUG),
    HOENN_TO_NATIONAL(SNUGGYBARA),
    HOENN_TO_NATIONAL(PINGLOO),
    HOENN_TO_NATIONAL(PENGLACIER),
    HOENN_TO_NATIONAL(CABOB),
    HOENN_TO_NATIONAL(LYNXSKEW),
    HOENN_TO_NATIONAL(HOOTHOOT),
    HOENN_TO_NATIONAL(NOCTOWL),
    HOENN_TO_NATIONAL(DOCTOWL),
    ...
    HOENN_TO_NATIONAL(SKULLARVA),
    HOENN_TO_NATIONAL(KAKONE),
    HOENN_TO_NATIONAL(MORTASQUE),
    ...
    HOENN_TO_NATIONAL(TENROCK),
    HOENN_TO_NATIONAL(SHREWEL),
    HOENN_TO_NATIONAL(PANGOLEM),
    ...
    HOENN_TO_NATIONAL(ICETOPE),
    HOENN_TO_NATIONAL(CHILLNOBYL),
    HOENN_TO_NATIONAL(TOXEL),
    HOENN_TO_NATIONAL(TOXTRICITY),
    HOENN_TO_NATIONAL(PUMACH),
    HOENN_TO_NATIONAL(JAGWIRE),
    HOENN_TO_NATIONAL(CHIHAHA),
    HOENN_TO_NATIONAL(HOWLEQUIN),
    HOENN_TO_NATIONAL(PALLECTRON),
    HOENN_TO_NATIONAL(CALUMMOTOR),
    HOENN_TO_NATIONAL(ELECTRIOCEROS),
    ...
    HOENN_TO_NATIONAL(FOLTERGEIST),
    HOENN_TO_NATIONAL(FANTASMARE),
    ...
    HOENN_TO_NATIONAL(TOTTER),
    HOENN_TO_NATIONAL(CASCOTTA),
    HOENN_TO_NATIONAL(LUTRAJET),
    HOENN_TO_NATIONAL(CHIMPOCA),
    HOENN_TO_NATIONAL(SIMAYAN),
    HOENN_TO_NATIONAL(PSYYNEN),
    HOENN_TO_NATIONAL(AANCHGORA),
    ...
    HOENN_TO_NATIONAL(SALAGUADE),
    HOENN_TO_NATIONAL(IGUASH),
    HOENN_TO_NATIONAL(JUGGERCROC),
    ...
    HOENN_TO_NATIONAL(ARROWBIN),
    HOENN_TO_NATIONAL(HAWTCHET),
    HOENN_TO_NATIONAL(CHIEFTURK),
    HOENN_TO_NATIONAL(FAWNPIRE),
    HOENN_TO_NATIONAL(ALPACULA),
    HOENN_TO_NATIONAL(MOOSEFERATU),
    HOENN_TO_NATIONAL(PLATYPOW),
    HOENN_TO_NATIONAL(PLATYPUNCH),
    HOENN_TO_NATIONAL(SILKINDER),
    HOENN_TO_NATIONAL(SENSILK),
    HOENN_TO_NATIONAL(STARYU),
    HOENN_TO_NATIONAL(STARMIE),
    HOENN_TO_NATIONAL(WINGULL),
    HOENN_TO_NATIONAL(PELIPPER),
    HOENN_TO_NATIONAL(SQUIBBLE),
    HOENN_TO_NATIONAL(SQUINGO),
    HOENN_TO_NATIONAL(NATU),
    HOENN_TO_NATIONAL(XATU),
    HOENN_TO_NATIONAL(UNOWN),
    HOENN_TO_NATIONAL(ESOTEROWN),
    ...
    HOENN_TO_NATIONAL(DALTOM),
    HOENN_TO_NATIONAL(OPPENHION),
    HOENN_TO_NATIONAL(GOLTERRA),
    HOENN_TO_NATIONAL(GAIOLEM),
    ...
    HOENN_TO_NATIONAL(SEDIRROT),
    HOENN_TO_NATIONAL(CONDESA),
    HOENN_TO_NATIONAL(NOBUNATA),
    HOENN_TO_NATIONAL(SOMBERO),
    ...
    HOENN_TO_NATIONAL(CARBITE),
    HOENN_TO_NATIONAL(PRESSAUR),
    HOENN_TO_NATIONAL(DIAMAW),
    ...
    HOENN_TO_NATIONAL(GILLA),
    HOENN_TO_NATIONAL(ANODONTOR),
    HOENN_TO_NATIONAL(ANKILLOSAUR),
    HOENN_TO_NATIONAL(BAZILISK),
    HOENN_TO_NATIONAL(ORNITHAUR),
    HOENN_TO_NATIONAL(DILOPHLORA),
    HOENN_TO_NATIONAL(NEUREKA),
    HOENN_TO_NATIONAL(EDISYNAPSE),
    HOENN_TO_NATIONAL(SCLICK),
    HOENN_TO_NATIONAL(VECTRION),
    ...
    HOENN_TO_NATIONAL(WAILLORD),
    HOENN_TO_NATIONAL(BINACLE),
    HOENN_TO_NATIONAL(BARBACLE),
    HOENN_TO_NATIONAL(FINIZEN),
    HOENN_TO_NATIONAL(PALAFIN),
    HOENN_TO_NATIONAL(DRAKNARR),
    HOENN_TO_NATIONAL(RAGNAROW),
    HOENN_TO_NATIONAL(MANDALLOY),
    HOENN_TO_NATIONAL(VULPIX),
    HOENN_TO_NATIONAL(NINETAILS),
    ...
    HOENN_TO_NATIONAL(PHLASK),
    HOENN_TO_NATIONAL(NOXIGHAST),
    HOENN_TO_NATIONAL(FUMIGHAST),
    HOENN_TO_NATIONAL(PINECALF),
    HOENN_TO_NATIONAL(TRUNKONIFR),
    HOENN_TO_NATIONAL(MASKREEP),
    HOENN_TO_NATIONAL(PHANTIKI),
    HOENN_TO_NATIONAL(TANUKOON),
    HOENN_TO_NATIONAL(LEUKOON),
    HOENN_TO_NATIONAL(TAOMARIN),
    HOENN_TO_NATIONAL(ORANGUTAO),
    HOENN_TO_NATIONAL(WISHP),
    HOENN_TO_NATIONAL(IGFRIT),
    HOENN_TO_NATIONAL(DJINNFERNO),
    ...
    HOENN_TO_NATIONAL(COALT),
    HOENN_TO_NATIONAL(ARISKORCH),
    HOENN_TO_NATIONAL(BLUFFIN),
    HOENN_TO_NATIONAL(SKARPIE),
    HOENN_TO_NATIONAL(GNOWM),
    HOENN_TO_NATIONAL(SNOWGRE),
    HOENN_TO_NATIONAL(BOAREALIS),
