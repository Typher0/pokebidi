...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Sound     Stellar
    ...
    [TYPE_GHOST]    = {______, X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), STL_RS, ______, ______, ______, ______, ______, PSY_RS, ______, ______, X(0.5), ______, X(2.0), ______},
    ...
    [TYPE_WATER]    = {______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______, X(0.5), ______},
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, ______, X(0.5), ______, ______, X(2.0), ______},
    ...
    [TYPE_SOUND]    = {______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, X(0.5), ______, ______, X(2.0), ______, ______},
...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    [TYPE_SOUND] =
    {
        ...
        .isSpecialCaseType = FALSE,
        .isHiddenPowerType = FALSE,
        //.enhanceItem = ITEM_MP3_PLAYER,
        //.berry = ITEM_NINIKU_BERRY,
        //.gem = ITEM_SOUND_GEM,
        //.zCrystal = ITEM_SOUNDIUM_Z,
        //.plate = ITEM_SONAR_PLATE,
        //.memory = ITEM_SOUND_MEMORY,
        //.teraShard = ITEM_SOUND_TERA_SHARD,
        //.arceusForm = SPECIES__ARCEUS_SOUND,
    },
    [TYPE_STELLAR] =
    {
        .name = _("Stellar"),
