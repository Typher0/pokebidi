...
#if P_FAMILY_HAMSNUG
PLACEHOLDER_ANIM_SINGLE_FRAME(Hamsnug);
PLACEHOLDER_ANIM_SINGLE_FRAME(Snuggybara);
#endif //P_FAMILY_HAMSNUG

#if P_FAMILY_PINGLOO
PLACEHOLDER_ANIM_SINGLE_FRAME(Pingloo);
PLACEHOLDER_ANIM_SINGLE_FRAME(Penglacier);
#endif //P_FAMILY_PINGLOO

#if P_FAMILY_CABOB
PLACEHOLDER_ANIM_SINGLE_FRAME(Cabob);
PLACEHOLDER_ANIM_SINGLE_FRAME(Lynxskew);
#endif //P_FAMILY_CABOB

#if P_FAMILY_PUMACH
PLACEHOLDER_ANIM_SINGLE_FRAME(Pumach);
PLACEHOLDER_ANIM_SINGLE_FRAME(Jagwire);
#endif //P_FAMILY_PUMACH

#if P_FAMILY_SKULLARVA
PLACEHOLDER_ANIM_SINGLE_FRAME(Skullarva);
PLACEHOLDER_ANIM_SINGLE_FRAME(Kakone);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mortasque);
#endif //P_FAMILY_SKULLARVA

#if P_FAMILY_TOTTER
PLACEHOLDER_ANIM_SINGLE_FRAME(Totter);
PLACEHOLDER_ANIM_SINGLE_FRAME(Cascotta);
PLACEHOLDER_ANIM_SINGLE_FRAME(Lutrajet);
#endif //P_FAMILY_TOTTER

#if P_FAMILY_TENROCK
PLACEHOLDER_ANIM_SINGLE_FRAME(Tenrock);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shrewel);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pangolem);
#endif //P_FAMILY_TENROCK

#if P_FAMILY_SHELFUR
PLACEHOLDER_ANIM_SINGLE_FRAME(Shelfur);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ignoise);
PLACEHOLDER_ANIM_SINGLE_FRAME(Moltortoise);
#endif //P_FAMILY_SHELFUR

#if P_FAMILY_CHIHAHA
PLACEHOLDER_ANIM_SINGLE_FRAME(Chihaha);
PLACEHOLDER_ANIM_SINGLE_FRAME(Howlequin);
#endif //P_FAMILY_CHIHAHA

#if P_FAMILY_PALLECTRON
PLACEHOLDER_ANIM_SINGLE_FRAME(Pallectron);
PLACEHOLDER_ANIM_SINGLE_FRAME(Callummotor);
PLACEHOLDER_ANIM_SINGLE_FRAME(Electrioceros);
#endif //P_FAMILY_PALLECTRON

#if P_FAMILY_CHIMPOCA
PLACEHOLDER_ANIM_SINGLE_FRAME(Chimpoca);
PLACEHOLDER_ANIM_SINGLE_FRAME(Simayan);
#endif //P_FAMILY_CHIMPOCA

#if P_FAMILY_ICETOPE
static const union AnimCmd sAnim_Icetope_1[] =
{
    ANIMCMD_FRAME(0, 30),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 30),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Chillnobyl);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Aanchgora);
#endif //P_FAMILY_PSYYNEN

#if P_FAMILY_FOLTERGEIST
PLACEHOLDER_ANIM_SINGLE_FRAME(Foltergeist);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fantasmare);
#endif //P_FAMILY_FOLTERGEIST

#if P_FAMILY_CUPPY
PLACEHOLDER_ANIM_SINGLE_FRAME(Cuppy);
PLACEHOLDER_ANIM_SINGLE_FRAME(Fettlekish);
#endif //P_FAMILY_CUPPY

#if P_FAMILY_NECTRI
PLACEHOLDER_ANIM_SINGLE_FRAME(Nectri);
PLACEHOLDER_ANIM_SINGLE_FRAME(Hummiscus);
PLACEHOLDER_ANIM_SINGLE_FRAME(Nectriary);
#endif //P_FAMILY_NECTRI

#if P_FAMILY_CARDINITE
PLACEHOLDER_ANIM_SINGLE_FRAME(Cardinite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Chardinal);
#endif //P_FAMILY_CARDINITE

#if P_FAMILY_SALAGUADE
PLACEHOLDER_ANIM_SINGLE_FRAME(Salaguade);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Arrowbin);
...
#if P_FAMILY_SCLICK
PLACEHOLDER_ANIM_SINGLE_FRAME(Sclick);
PLACEHOLDER_ANIM_SINGLE_FRAME(Vectrion);
#endif //P_FAMILY_SCLICK

#if P_FAMILY_FAWNPIRE
PLACEHOLDER_ANIM_SINGLE_FRAME(Fawnpire);
PLACEHOLDER_ANIM_SINGLE_FRAME(Alpacula);
PLACEHOLDER_ANIM_SINGLE_FRAME(Mooseferatu);
#endif //P_FAMILY_FAWNPIRE

#if P_FAMILY_PLATYPOW
PLACEHOLDER_ANIM_SINGLE_FRAME(Platypow);
PLACEHOLDER_ANIM_SINGLE_FRAME(Platypunch);
#endif //P_FAMILY_PLATYPOW

#if P_FAMILY_SILKINDER
PLACEHOLDER_ANIM_SINGLE_FRAME(Silkinder);
PLACEHOLDER_ANIM_SINGLE_FRAME(Sensilk);
#endif //P_FAMILY_SILKINDER

#if P_FAMILY_DALTOM
PLACEHOLDER_ANIM_SINGLE_FRAME(Daltom);
PLACEHOLDER_ANIM_SINGLE_FRAME(Oppenhion);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Relladune);
PLACEHOLDER_ANIM_SINGLE_FRAME(Camorella);
#endif //P_FAMILY_RELLADUNE

#if P_FAMILY_COBOE
PLACEHOLDER_ANIM_SINGLE_FRAME(Coboe);
PLACEHOLDER_ANIM_SINGLE_FRAME(Pungriyadh);
#endif //P_FAMILY_COBOE

#if P_FAMILY_SEDIRROT
PLACEHOLDER_ANIM_SINGLE_FRAME(Sedirrot);
PLACEHOLDER_ANIM_SINGLE_FRAME(Condesa);
#endif //P_FAMILY_SEDIRROT

#if P_FAMILY_NOBUNATA
PLACEHOLDER_ANIM_SINGLE_FRAME(Nobunata);
#endif //P_FAMILY_NOBUNATA

#if P_FAMILY_SOMBERO
PLACEHOLDER_ANIM_SINGLE_FRAME(Sombero);
#endif //P_FAMILY_SOMBERO

#if P_FAMILY_MINARAC
PLACEHOLDER_ANIM_SINGLE_FRAME(Minarac);
PLACEHOLDER_ANIM_SINGLE_FRAME(Tarenchula);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Diamaw);
#endif //P_FAMILY_CARBITE

#if P_FAMILY_GILLA
PLACEHOLDER_ANIM_SINGLE_FRAME(Gilla);
PLACEHOLDER_ANIM_SINGLE_FRAME(Anodontor);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ankillosaur);
#endif //P_FAMILY_GILLA

#if P_FAMILY_BAZILISK
PLACEHOLDER_ANIM_SINGLE_FRAME(Bazilisk);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ornithaur);
PLACEHOLDER_ANIM_SINGLE_FRAME(Dilophlora);
#endif //P_FAMILY_BAZILISK

#if P_FAMILY_SQUIBBLE
PLACEHOLDER_ANIM_SINGLE_FRAME(Squibble);
PLACEHOLDER_ANIM_SINGLE_FRAME(Squingo);
#endif //P_FAMILY_SQUIBBLE

#if P_FAMILY_DRAKNARR
PLACEHOLDER_ANIM_SINGLE_FRAME(Draknarr);
PLACEHOLDER_ANIM_SINGLE_FRAME(Ragnarow);
#endif //P_FAMILY_DRAKNARR

#if P_FAMILY_MANDALLOY
PLACEHOLDER_ANIM_SINGLE_FRAME(Mandalloy);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Pinecalf);
PLACEHOLDER_ANIM_SINGLE_FRAME(Trunkonifr);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Taomarin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Orangutao);
...
#if P_FAMILY_BLUFFIN
PLACEHOLDER_ANIM_SINGLE_FRAME(Bluffin);
PLACEHOLDER_ANIM_SINGLE_FRAME(Skarpie);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Boarealis);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Djinnferno);
#endif //P_FAMILY_WISHP

#if P_FAMILY_MOONIGHT
PLACEHOLDER_ANIM_SINGLE_FRAME(Moonight);
PLACEHOLDER_ANIM_SINGLE_FRAME(Joustock);
PLACEHOLDER_ANIM_SINGLE_FRAME(Crusaber);
#endif //P_FAMILY_MOONIGHT

#if P_FAMILY_CHELONITE
PLACEHOLDER_ANIM_SINGLE_FRAME(Chelonite);
PLACEHOLDER_ANIM_SINGLE_FRAME(Galaxagos);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Babosiris);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Wendingo);
