...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Punches with a cold rock\n"
            "fist, may cause frostbite."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_ROCK,
        .accuracy = 95,
    ...
    [MOVE_GIGA_DRAIN] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "the damage inflicted."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 90,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_DRAIN_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "half the damage inflicted."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 60,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_SPACIAL_REND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Tears space to slash foe.\n"
            "Lowers both defenses."),
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_DRAGON,
        .accuracy = 90,
    ...
    [MOVE_HAPPY_HOUR] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lets an ally drink way too\n"
            "much to raise their Attack."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_CELEBRATE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Celebrates a teammate's success\n"
            "to raise their Speed x2."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 70 : 50,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 15,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
    ...
    {
        .name = COMPOUND_STRING("EsotericDestruction"),
        .description = COMPOUND_STRING(
            "The type varies with the\n"
            "kind of Plate held."),
        .effect = EFFECT_CHANGE_TYPE_ON_ITEM,
    ...
    [MOVE_MEXICAN_STANDOFF] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_MexicanStandoff,
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_ROLL_AROUND] =
    {
        .name = COMPOUND_STRING("Roll Around"),
        .description = COMPOUND_STRING(
            "Rolls around in dirt\n"
            "making the user Ground-type."),
        .effect = EFFECT_THIRD_TYPE,
        .power = 0,
        .type = TYPE_GROUND,
        .accuracy = 0,
        ...
        .battleAnimScript = gBattleAnimMove_RollAround,
        .zMove = { .effect = Z_EFFECT_ALL_STATS_UP_1 },
        .contestEffect = CONTEST_EFFECT_WORSEN_CONDITION_OF_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
    ...
    [MOVE_GRAVITATE] =
    {
        .name = COMPOUND_STRING("Gravitate"),
        .description = COMPOUND_STRING(
            "Pulls in the attacks of\n"
            "opposing Pokémon."),
        .effect = EFFECT_FOLLOW_ME,
        .power = 0,
        .type = TYPE_NORMAL,
        ...
        .priority = 3,
        .category = DAMAGE_CATEGORY_STATUS,
        .battleAnimScript = gBattleAnimMove_Gravitate,
        .zMove = { .effect = Z_EFFECT_SPDEF_UP_1 },
        .magicCoatAffected = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
    ...
    [MOVE_YODEL] =
    {
        .name = COMPOUND_STRING("Yodel"),
        .description = COMPOUND_STRING(
            "Lowers Sp. Def, but hurts\n"
            "throat so lowers Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_SOUND,
        .accuracy = 90,
        ...
        .battleAnimScript = gBattleAnimMove_Yodel,
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_DISINFECTANT] =
    {
        .name = COMPOUND_STRING("Disinfectant"),
        .description = COMPOUND_STRING(
            "x2 damage on poisoned foes,\n"
            "cures them, flinch chance."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 40,
        .type = TYPE_POISON,
        .accuracy = 95,
        ...
        .battleAnimScript = gBattleAnimMove_Disinfectant,
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_RUSTY_JAW] =
    {
        .name = COMPOUND_STRING("Rusty Jaw"),
        .description = COMPOUND_STRING(
            "A rusty chomp that does\n"
            "x2 damage to poisoned foes."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 55,
        .type = TYPE_STEEL,
        .accuracy = 95,
        ...
        .battleAnimScript = gBattleAnimMove_RustyJaw,
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MON,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_LULLABY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            .category = DAMAGE_CATEGORY_STATUS,
            .argument = { .nonVolatileStatus = MOVE_EFFECT_SLEEP },
            .battleAnimScript = gBattleAnimMove_Lullaby,
            .zMove = { .effect = Z_EFFECT_RESET_STATS },
            .ignoresSubstitute = B_UPDATED_MOVE_FLAGS >= GEN_6,
            .magicCoatAffected = TRUE,
            .soundMove = TRUE,
    ...
    [MOVE_IRRADIATE] =
    {
        .name = COMPOUND_STRING("Irradiate"),
        .description = COMPOUND_STRING(
            "Shoots an irradiated\n"
            "beam that badly poison."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
        .accuracy = 100,
        ...
        .battleAnimScript = gBattleAnimMove_Irradiate,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = COMBO_STARTER_SCALD,
        .contestComboMoves = {0},
    ...
    [MOVE_NEUROTOXIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Injects a neurotoxin in the\n"
            "foe. May inflict paralysis."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_QUICK_SAND] =
    {
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_QuickSand,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_FLASH_STEP] =
    {
        .name = COMPOUND_STRING("Flash Step"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_FlashStep,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_SPARKLING_RAMPAGE] =
    {
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = gBattleAnimMove_SparklingRampage,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_TWISTED_HASTE] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_TwistedHaste,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_SPEED_ROOT] =
    {
        .name = COMPOUND_STRING("Speed Root"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = gBattleAnimMove_SpeedRoot,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_CYCLONE_BOOST] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_CycloneBoost,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_MIND_RACE] =
    {
        .name = COMPOUND_STRING("Mind Race"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = gBattleAnimMove_MindRace,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_ROCKET_RUSH] =
    {
        .name = COMPOUND_STRING("Rocket Rush"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .battleAnimScript = gBattleAnimMove_RocketRush,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_BLISTER_BANE] =
    {
        .name = COMPOUND_STRING("Blister Bane"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_BlisterBane,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_BUZZING_BUSTLE] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .battleAnimScript = gBattleAnimMove_BuzzingBustle,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
    ...
    [MOVE_SABER_THRUST] =
    {
        .name = COMPOUND_STRING("Saber Thrust"),
        .description = COMPOUND_STRING(
        ...
        .makesContact = TRUE,
        .alwaysCriticalHit = TRUE,
        .battleAnimScript = gBattleAnimMove_SaberThrust,
        .contestEffect = CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_SWORDS_DANCE},
    ...
    [MOVE_VIBRANT_ARROW] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .alwaysCriticalHit = TRUE,
        .battleAnimScript = gBattleAnimMove_VibrantArrow,
        .contestEffect = CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_GAIA_HAMMER] =
    {
        .name = COMPOUND_STRING("Gaia Hammer"),
        .description = COMPOUND_STRING(
        ...
        .minimizeDoubleDamage = TRUE,
        .skyBattleBanned = TRUE,
        .battleAnimScript = gBattleAnimMove_GaiaHammer,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_MOLTEN_HORNS] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_MoltenHorns,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_POSSESSION] =
    {
        .name = COMPOUND_STRING("Possession"),
        .description = COMPOUND_STRING(
            "The higher the foe's Attack\n"
            "the more damage caused."),
        .effect = EFFECT_FOUL_PLAY,
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_Possession,
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_KAMIKAZE] =
    {
        ...
        .mirrorMoveBanned = TRUE,
        .parentalBondBanned = TRUE,
        .battleAnimScript = gBattleAnimMove_Kamikaze,
        .contestEffect = CONTEST_EFFECT_GREAT_APPEAL_BUT_NO_MORE_MOVES,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_CANNIBALIZE] =
    {
        .name = COMPOUND_STRING("Cannibalize"),
        .description = COMPOUND_STRING(
            "The user bites meat off the\n"
            "foe, healing half the damage."),
        ...
        .ignoresKingsRock = (B_UPDATED_MOVE_FLAGS == GEN_3 || B_UPDATED_MOVE_FLAGS == GEN_4),
        .healingMove = B_HEAL_BLOCKING >= GEN_6,
        .battleAnimScript = gBattleAnimMove_Cannibalize,
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_EXORCISM] =
    {
        ...
        .battleAnimScript = gBattleAnimMove_Exorcism,
        .contestEffect = CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_INSECTICIDE] =
    {
        .name = COMPOUND_STRING("Insecticide"),
        .description = COMPOUND_STRING(
        ...
        .battleAnimScript = gBattleAnimMove_Insecticide,
        .contestEffect = CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_DRACO_DRIVE] =
    {
        .name = COMPOUND_STRING("Draco Drive"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        ...
        .priority = 1,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .battleAnimScript = gBattleAnimMove_DracoDrive,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_DOUBLE_TEAM},
