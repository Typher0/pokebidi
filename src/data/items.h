...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SMACK_DOWN] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "Throws a stone to knock a\n"
            "flying Pokémon to thel\n"
    ...
    [ITEM_TM_SKY_DROP] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "Hurls the foe into the air,\n"
            "then drops it next turn.\n"
            "Foe can't attack in the air."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    ...
    [ITEM_TM_TERA_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            "A strange attack\n"
            "that changes type to\n"
            "match user's Tera Type."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
...
// Gen 9 Items
    ...
    [ITEM_SOUND_TERA_SHARD] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_TeraShard,
        .iconPalette = gItemIconPalette_SoundTeraShard,
    },
