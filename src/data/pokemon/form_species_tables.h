...
static const u16 sForetressFormSpeciesIdTable[] = {
    SPECIES_FORETRESS,
    SPECIES_FORETRESS_ILATIA,
};
...
#if P_FAMILY_SHUPPET
static const u16 sShuppetFormSpeciesIdTable[] = {
    SPECIES_SHUPPET,
...
static const u16 sCofagrigusFormSpeciesIdTable[] = {
    SPECIES_COFAGRIGUS,
#if P_MEGA_EVOLUTIONS
...
#if P_FAMILY_LARVIRE
static const u16 sMagmantFormSpeciesIdTable[] = {
    SPECIES_MAGMANT,
...
#if P_FAMILY_ENJEL
static const u16 sSeraneFormSpeciesIdTable[] = {
    SPECIES_SERANE_NORMAL,
    SPECIES_SERANE_FIGHTING,
    SPECIES_SERANE_FLYING,
    SPECIES_SERANE_POISON,
    SPECIES_SERANE_GROUND,
    SPECIES_SERANE_ROCK,
    SPECIES_SERANE_BUG,
    SPECIES_SERANE_GHOST,
    SPECIES_SERANE_STEEL,
    SPECIES_SERANE_FIRE,
    SPECIES_SERANE_WATER,
    SPECIES_SERANE_GRASS,
    SPECIES_SERANE_ELECTRIC,
    SPECIES_SERANE_PSYCHIC,
    SPECIES_SERANE_ICE,
    SPECIES_SERANE_DRAGON,
    SPECIES_SERANE_DARK,
    SPECIES_SERANE_FAIRY,
    SPECIES_SERANE_SOUND,
};

static const u16 sDaiellFormSpeciesIdTable[] = {
    SPECIES_DAIELL_NORMAL,
    SPECIES_DAIELL_FIGHTING,
    SPECIES_DAIELL_FLYING,
    SPECIES_DAIELL_POISON,
    SPECIES_DAIELL_GROUND,
    SPECIES_DAIELL_ROCK,
    SPECIES_DAIELL_BUG,
    SPECIES_DAIELL_GHOST,
    SPECIES_DAIELL_STEEL,
    SPECIES_DAIELL_FIRE,
    SPECIES_DAIELL_WATER,
    SPECIES_DAIELL_GRASS,
    SPECIES_DAIELL_ELECTRIC,
    SPECIES_DAIELL_PSYCHIC,
    SPECIES_DAIELL_ICE,
    SPECIES_DAIELL_DRAGON,
    SPECIES_DAIELL_DARK,
    SPECIES_DAIELL_FAIRY,
    SPECIES_DAIELL_SOUND,
};
#endif //P_FAMILY_ENJEL

#if P_FAMILY_RIDEQUIN
static const u16 sEquriorFormSpeciesIdTable[] = {
    SPECIES_EQURIOR_MALE,
    SPECIES_EQURIOR_FEMALE,
};

static const u16 sStalliotFormSpeciesIdTable[] = {
    SPECIES_STALLIOT_MALE,
    SPECIES_STALLIOT_FEMALE,
};
#endif //P_FAMILY_RIDEQUIN

#if P_FAMILY_STACODE
static const u16 sStacodeFormSpeciesIdTable[] = {
    SPECIES_STACODE,
