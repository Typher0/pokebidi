...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_INSOMNIA, ABILITY_LONG_REACH },
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE, CONDITIONS({IF_NOT_REGION, REGION_HISUI})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_HOLD_ITEM, ITEM_BLACK_AUGURITE})}
                            #endif
                            ),
    },
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, ABILITY_INSOMNIA, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_FRISK, ABILITY_INTIMIDATE },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_OBLIVIOUS, ABILITY_LIQUID_VOICE },
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MINDS_EYE, ABILITY_STAMINA, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
...
#define SILVALLY_SPECIES_INFO(type, _palette)                                       \
    ...
    [SPECIES_SILVALLY_SOUND]    = SILVALLY_SPECIES_INFO(TYPE_SOUND,    Sound),
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_HAKAMO_O] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_DRAGON, TYPE_SOUND),
        .catchRate = 45,
        .expYield = 147,
        .evYield_Defense = 2,
        .itemRare = ITEM_RAZOR_CLAW,
