...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_FLOWER_VEIL, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_TYPHLOSION_MEGA] =
    {
        ...
        .weight = 835,
        .description = COMPOUND_STRING(
            "Its intense flames have gotten even\n"
            "hotter and have become blue.\n"
            "Typhlosion create blazing explosive\n"
            "blasts that burn everything to cinders."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .baseDefense   = 50,
        .baseSpeed     = 75,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 92 : 76,
        .baseSpDefense = 110,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 90,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_PINECO_ILATIA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PinecoIlatia,
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(40, 48) : MON_COORDS_SIZE(40, 40),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 10 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_SWING_CONCAVE,
        .backPic = gMonBackPic_PinecoIlatia,
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 15 : 13,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = gMonPalette_PinecoIlatia,
        .shinyPalette = gMonShinyPalette_PinecoIlatia,
        .iconSprite = gMonIcon_PinecoIlatia,
        .iconPalIndex = 0,
        .pokemonJumpType = PKMN_JUMP_TYPE_SLOW,
        SHADOW(0, 2, SHADOW_SIZE_S)
        FOOTPRINT(Pineco)
        .levelUpLearnset = sPinecoIlatiaLevelUpLearnset,
        .teachableLearnset = sPinecoIlatiaTeachableLearnset,
        .eggMoveLearnset = sPinecoIlatiaEggMoveLearnset,
        .formSpeciesIdTable = sPinecoFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_FORRETRESS_ILATIA}),
    },

    [SPECIES_FORRETRESS_ILATIA] =
    {
        .baseHP        = 95,
        .baseAttack    = 65,
        .baseDefense   = 65,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_ForretressIlatia,
        .frontPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(56, 48) : MON_COORDS_SIZE(64, 48),
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 9 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 10),
        ...
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = gMonBackPic_ForretressIlatia,
        .backPicSize = MON_COORDS_SIZE(64, 32),
        .backPicYOffset = 16,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_ForretressIlatia,
        .shinyPalette = gMonShinyPalette_ForretressIlatia,
        .iconSprite = gMonIcon_ForretressIlatia,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(0, 6, SHADOW_SIZE_L)
        FOOTPRINT(Forretress)
        .levelUpLearnset = sForretressIlatiaLevelUpLearnset,
        .teachableLearnset = sForretressIlatiaTeachableLearnset,
    ...
    [SPECIES_MAMOSWINE_MEGA] =
    {
        ...
        .trainerScale = 423,
        .trainerOffset = 8,
        .frontPic = gMonFrontPic_MamoswineMega,
        .frontPicSize = MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
        ...
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = gMonPalette_MamoswineMega,
        .shinyPalette = gMonShinyPalette_MamoswineMega,
        .iconSprite = gMonIcon_MamoswineMega,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NONE,
        SHADOW(7, 7, SHADOW_SIZE_L)
        FOOTPRINT(Mamoswine)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CURSOLA})
    },
