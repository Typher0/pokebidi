...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_PORYGON_Z_MEGA, ITEM_PORYGONITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_FERALIGATR_MEGA, ITEM_AMPHAROSITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_EXPLOUD_MEGA, ITEM_EXPLOUDITE},
#endif
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_ROUTE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_SAFARI},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_SEA},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_BRIDGE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_DESERT},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_TRASH, BATTLE_ENVIRONMENT_INDOOR},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sArceusFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCEUS_SOUND,    ITEM_SONAR_PLATE,  ABILITY_MULTITYPE},
...
static const struct FormChange sSilvallyFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_SOUND,    ITEM_SOUND_MEMORY,    ABILITY_RKS_SYSTEM},
    {FORM_CHANGE_TERMINATOR},
};
...
#if P_FAMILY_ENJEL
static const struct FormChange sSeraneFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_NORMAL,   ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FIGHTING, ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FIGHTING, ITEM_FIGHTINIUM_Z, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FLYING,   ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FLYING,   ITEM_FLYINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_POISON,   ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_POISON,   ITEM_POISONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ROCK,     ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ROCK,     ITEM_ROCKIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GROUND,   ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GROUND,   ITEM_GROUNDIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_BUG,      ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_BUG,      ITEM_BUGINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GHOST,    ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GHOST,    ITEM_GHOSTIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_STEEL,    ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_STEEL,    ITEM_STEELIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FIRE,     ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FIRE,     ITEM_FIRIUM_Z,     ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_WATER,    ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_WATER,    ITEM_WATERIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GRASS,    ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_GRASS,    ITEM_GRASSIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ELECTRIC, ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ELECTRIC, ITEM_ELECTRIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_PSYCHIC,  ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_PSYCHIC,  ITEM_PSYCHIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ICE,      ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_ICE,      ITEM_ICIUM_Z,      ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_DRAGON,   ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_DRAGON,   ITEM_DRAGONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_DARK,     ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_DARK,     ITEM_DARKINIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FAIRY,    ITEM_PIXIE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_FAIRY,    ITEM_FAIRIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SERANE_SOUND,    ITEM_SOUND_TERA_SHARD,    ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDaiellFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_NORMAL,   ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FIGHTING, ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FIGHTING, ITEM_FIGHTINIUM_Z, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FLYING,   ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FLYING,   ITEM_FLYINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_POISON,   ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_POISON,   ITEM_POISONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ROCK,     ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ROCK,     ITEM_ROCKIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GROUND,   ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GROUND,   ITEM_GROUNDIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_BUG,      ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_BUG,      ITEM_BUGINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GHOST,    ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GHOST,    ITEM_GHOSTIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_STEEL,    ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_STEEL,    ITEM_STEELIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FIRE,     ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FIRE,     ITEM_FIRIUM_Z,     ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_WATER,    ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_WATER,    ITEM_WATERIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GRASS,    ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_GRASS,    ITEM_GRASSIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ELECTRIC, ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ELECTRIC, ITEM_ELECTRIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_PSYCHIC,  ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_PSYCHIC,  ITEM_PSYCHIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ICE,      ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_ICE,      ITEM_ICIUM_Z,      ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_DRAGON,   ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_DRAGON,   ITEM_DRAGONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_DARK,     ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_DARK,     ITEM_DARKINIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FAIRY,    ITEM_PIXIE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_FAIRY,    ITEM_FAIRIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_DAIELL_SOUND,    ITEM_SOUND_TERA_SHARD,    ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
#endif //P_FAMILY_ENJEL

#if P_FAMILY_STACODE
static const struct FormChange sStacodeFormChangeTable[] = {
    {FORM_CHANGE_FAINT,         SPECIES_STACODE},
    {FORM_CHANGE_END_BATTLE,    SPECIES_STACODE},
    {FORM_CHANGE_TERMINATOR},
};
