...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_EXPERT] = { _("Expert"), 10, BALL_ },
    ...
    [TRAINER_CLASS_SINGULARITY_ADMIN] = { _("S. Admin"), 10 },
    [TRAINER_CLASS_TEAM_SINGULARITY] = { _("Singularity"), 5, BALL_DUSK },
    [TRAINER_CLASS_SINGULARITY_BOSS] = { _("S. Boss"), 20 },
    [TRAINER_CLASS_BACKERS] = { _("Backers"), 8, BALL_PREMIER },
    [TRAINER_CLASS_BACKPACKER] = { _("Backpacker"), 3 },
    [TRAINER_CLASS_BELLE_PA] = { _("Belle Pa"), 7, BALL_NEST },
    [TRAINER_CLASS_BOARDER] = { _("Boarder"), 5, BALL_QUICK },
    [TRAINER_CLASS_CAPTAIN] = { _("Captain"), 25, BALL_ULTRA },
    [TRAINER_CLASS_CLERK] = { _("Clerk"), 8 },
    [TRAINER_CLASS_CLOWN] = { _("Clown"), 3 },
    [TRAINER_CLASS_COWGIRL] = { _("Cowgirl"), 8, BALL_SAFARI },
    [TRAINER_CLASS_DANCER] = { _("Dancer"), 8, BALL_QUICK },
    [TRAINER_CLASS_DIVER] = { _("Diver"), 8, BALL_DIVE },
    [TRAINER_CLASS_DOCTOR] = { _("Doctor"), 10, BALL_HEAL },
    [TRAINER_CLASS_FAIRYTALE] = { _("Fairytale"), 2, BALL_LOVE },
    [TRAINER_CLASS_FIREBREATHER] = { _("Firebreather"), 7 },
    [TRAINER_CLASS_FIREFIGHTER] = { _("Fireman"), 4 },
    [TRAINER_CLASS_FRONTIER_BRAIN] = { _("Frontier"), 20, BALL_STRANGE },
    [TRAINER_CLASS_HOOLIGANS] = { _("Hooligans"), 5, BALL_DUSK },
    [TRAINER_CLASS_ATHLETE] = { _("Athlete"), 20, BALL_FAST },
    [TRAINER_CLASS_POLICE] = { _("Officer") },
    [TRAINER_CLASS_KAHUNA] = { _("Kahuna"), 25, BALL_ULTRA },
    [TRAINER_CLASS_KIMONO_GIRL] = { _("Kimono Girl"), 8, BALL_MOON },
    [TRAINER_CLASS_MAID] = { _("Maid"), 3 },
    [TRAINER_CLASS_MEDIUM] = { _("Medium"), 5, BALL_DUSK },
    [TRAINER_CLASS_NURSE] = { _("Nurse"), 8, BALL_HEAL },
    [TRAINER_CLASS_NURSERY_AIDE] = { _("Aide"), 4, BALL_NEST },
    [TRAINER_CLASS_POSTMAN] = { _("Postman"), 5, BALL_QUICK },
    [TRAINER_CLASS_PROFESSOR] = { _("Prof."), 10, BALL_REPEAT },
    [TRAINER_CLASS_PUNK] = { _("Punk"), 4, BALL_DUSK },
    [TRAINER_CLASS_ROLLERSKATER] = { _("Rollerskater") },
    [TRAINER_CLASS_ROUGHNECK] = { _("Roughneck"), 4, BALL_DUSK },
    [TRAINER_CLASS_SAGE] = { _("Sage") },
    [TRAINER_CLASS_SECURITY] = { _("Security"), 10 },
    [TRAINER_CLASS_SHADOW] = { _("Shadow"), 10, BALL_DUSK },
    [TRAINER_CLASS_SKIER] = { _("Skier"), 8, BALL_QUICK },
    [TRAINER_CLASS_SKYTRAINER] = { _("Skytrainer"), 5, BALL_QUICK },
    [TRAINER_CLASS_VETRAN] = { _("Vetran"), 10, BALL_ULTRA },
    [TRAINER_CLASS_WAITER] = { _("Waiter"), 8 },
    [TRAINER_CLASS_WAITRESS] = { _("Waitress"), 8 },
    [TRAINER_CLASS_WORKER] = { _("Worker"), 5, BALL_HEAVY },
    [TRAINER_CLASS_INTERPOL_AGENT] = { _("Interpol"), 10, BALL_PARK },
    [TRAINER_CLASS_JANITOR] = { _("Janitor") },
    [TRAINER_CLASS_TEAM_PLASMA] = { _("Plasma"), 5, BALL_DUSK },
    [TRAINER_CLASS_SUBWAY_BOSS] = { _("Subway Boss"), 20, BALL_ULTRA },
    [TRAINER_CLASS_PHOTOGRAPHER] = { _("Photographer") },
    [TRAINER_CLASS_MODEL] = { _("Model"), 10, BALL_LUXURY },
    [TRAINER_CLASS_BODYBUILDER] = { _("Bodybuilder"), 20, BALL_FAST },
    [TRAINER_CLASS_ARTIST] = { _("Artist") },
    [TRAINER_CLASS_CAMERAMAN] = { _("Cameraman") },
    [TRAINER_CLASS_CYCLIST] = { _("Cyclist"), 5, BALL_FAST },
    [TRAINER_CLASS_IDOL] = { _("Idol"), 10, BALL_LOVE },
    [TRAINER_CLASS_JOGGER] = { _("Jogger"), 5, BALL_FAST },
    [TRAINER_CLASS_POKE_KID] = { _("Poke Kid"), 3 },
    [TRAINER_CLASS_RANCHER] = { _("Rancher"), 5, BALL_NEST },
    [TRAINER_CLASS_REPORTER] = { _("Reporter"), 8 },
    [TRAINER_CLASS_SOCIALITE] = { _("Socialite"), 15, BALL_LUXURY },
    [TRAINER_CLASS_DEPOT_AGENT] = { _("Depot Agent"), 10 },
