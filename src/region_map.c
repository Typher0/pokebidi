...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_PALLET_TOWN] = {MAP_GROUP(MAP_OCCHITA_VILLAGE), MAP_NUM(MAP_OCCHITA_VILLAGE), HEAL_LOCATION_OCCHITA_VILLAGE},
    [MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP(MAP_GANARIA_TOWN), MAP_NUM(MAP_GANARIA_TOWN), HEAL_LOCATION_GANARIA_TOWN},
    [MAPSEC_PEWTER_CITY] = {MAP_GROUP(MAP_KINGSTON_CITY), MAP_NUM(MAP_KINGSTON_CITY), HEAL_LOCATION_KINGSTON_CITY},
};
